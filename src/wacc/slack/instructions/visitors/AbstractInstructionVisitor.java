 ...
 * instructions eg. Branch or Label and want to pass some fail value when 
 * it is not in this subset. The fail value is provided via callable
 */
public class AbstractInstructionVisitor<T> implements
		InstructionVistor<T> {
	...
	public T visit(And and) {
		try{ return func.call();} catch(Exception e) {throw new RuntimeException(e);}
	}
