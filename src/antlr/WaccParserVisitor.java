...
public interface WaccParserVisitor<T> extends ParseTreeVisitor<T> {
	 ...
	 * @return the visitor result
	 */
	T visitBinaryOp(@NotNull WaccParser.BinaryOpContext ctx);
	/**
	...
	/**
	 * Visit a parse tree produced by the {@code exprInParenthesesExpr}
	 * labeled alternative in {@link WaccParser#expr}.
	 * @param ctx the parse tree
	 * @return the visitor result
	 */
	T visitExprInParenthesesExpr(@NotNull WaccParser.ExprInParenthesesExprContext ctx);
	/**
	...
	/**
	 * Visit a parse tree produced by the {@code ifWithoutElseStat}
	 * labeled alternative in {@link WaccParser#stat}.
	 * @param ctx the parse tree
	 * @return the visitor result
	 */
	T visitIfWithoutElseStat(@NotNull WaccParser.IfWithoutElseStatContext ctx);
	/**
	 ...
	 * @return the visitor result
	 */
	T visitUnaryExpr(@NotNull WaccParser.UnaryExprContext ctx);
	/**
